...
- [ ] Step 4: Install .cursor/rules/all-for-harness.mdc (and nest-conventions if Nest)
...
- Rule installed at `.cursor/rules/all-for-harness.mdc` (and `nest-conventions` if Nest)
