...
| Need | Path |
|---|---|
| Motion rules | `.cursor/skills/amaterasu/_jutsu/motion-principles/SKILL.md` |
| Mobile rules | `.cursor/skills/amaterasu/_jutsu/mobile-principles/SKILL.md` |
| Desktop rules | `.cursor/skills/amaterasu/_jutsu/desktop-principles/SKILL.md` |
