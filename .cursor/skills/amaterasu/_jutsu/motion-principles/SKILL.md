...
| Need | Path |
|---|---|
| Mobile UX | `.cursor/skills/amaterasu/_jutsu/mobile-principles/SKILL.md` |
| Desktop UX | `.cursor/skills/amaterasu/_jutsu/desktop-principles/SKILL.md` |
| Design audit | `.cursor/skills/amaterasu/_jutsu/design-audit/SKILL.md` |
| GSAP | `.cursor/skills/amaterasu/_jutsu/gsap/SKILL.md` |
| Framer Motion | `.cursor/skills/amaterasu/_jutsu/framer-motion/SKILL.md` |
| CSS native | `.cursor/skills/amaterasu/_jutsu/css-native/SKILL.md` |
| Three.js / R3F | `.cursor/skills/amaterasu/_jutsu/threejs-r3f/SKILL.md` |
| Compose motion | `.cursor/skills/amaterasu/_jutsu/compose-motion/SKILL.md` |
| SwiftUI motion | `.cursor/skills/amaterasu/_jutsu/swiftui-motion/SKILL.md` |
| UI/UX intelligence | `.cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/SKILL.md` |
