...
| Need | Path |
|---|---|
| Motion foundation | `.cursor/skills/amaterasu/_jutsu/motion-principles/SKILL.md` |
| SwiftUI motion | `.cursor/skills/amaterasu/_jutsu/swiftui-motion/SKILL.md` |
| Compose Desktop | `.cursor/skills/amaterasu/_jutsu/compose-multiplatform/SKILL.md` |
