...
go -C .cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/cli run . search "<query>" -domain style|color|typography|ux|product -max 3

go -C .cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/cli run . search "<query>" -stack react|nextjs|html-tailwind

go -C .cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/cli run . design-system "<product> <industry> <mood>"

go -C .cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/cli run . audit .

# Optional build once (binary next to data/)
go -C .cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/cli build -o ../amaterasu-ui .
```

Data dir: `.cursor/skills/amaterasu/_jutsu/ui-ux-pro-max/data/` (vendored CSVs).
