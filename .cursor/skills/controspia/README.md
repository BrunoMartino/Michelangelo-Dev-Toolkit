...
Não é o catálogo completo do projecto de origem — só as skills escolhidas para este harness (ver [Origem e licença](#origem-e-licença)).
...
│   └── red-legio/        # Engajamento de red team (ex-`red-team-engagement`)
├── report/
│   └── security-comms/   # Traduzir segurança para audiências não técnicas
├── LICENSE               # MIT (projecto de origem)
