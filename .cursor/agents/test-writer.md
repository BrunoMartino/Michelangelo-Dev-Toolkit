...
- `.cursor/skills/tester/SKILL.md` — TDD workflow (Red/Green/Refactor), two principles (name the break; exercise the real thing), mock/spy gates, triangulation matrix, handoff docs `docs/tdd/fase{N}.md` + `docs/tdd/fase{N}Task.md`, brownfield `docs/tdd/refactor-fase{N}.md`, `docs/testsReadme.md` registry.
