...
1. **Sync cache** (skip if fresh, < 7 days): `bash .claude/skills/learn-live-canvas/scripts/sync-docs.sh` from repo root.
...
curl -sL "https://docs.livecanvas.com/{slug}/" -o ".claude/skills/learn-live-canvas/reference/cache/docs/{slug}.html"
# Picostrap source file
curl -sL "https://raw.githubusercontent.com/livecanvas-team/picostrap5/master/{path}" -o ".claude/skills/learn-live-canvas/reference/cache/picostrap/{path}"
```
