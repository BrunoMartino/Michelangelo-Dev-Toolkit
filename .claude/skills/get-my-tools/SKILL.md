...
- Use when the user wants to **install or bring** skills, rules, or docs from [Michelangelo-Dev-Toolkit](https://github.com/BrunoMartino/Michelangelo-Dev-Toolkit) into the **current project**.
...
- **GitHub**: `https://github.com/BrunoMartino/Michelangelo-Dev-Toolkit`
- **Branch**: `main`

Try these methods **in order** (stop at first that works):

1. **`gh api`** — list contents under each catalog path (see table below).
2. **Raw GitHub** — `https://raw.githubusercontent.com/BrunoMartino/Michelangelo-Dev-Toolkit/main/<path>`
