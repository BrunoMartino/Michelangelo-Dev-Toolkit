...
`.claude/skills/amaterasu/_jutsu/<name>/SKILL.md`
...
Read `.claude/skills/amaterasu/_jutsu/web-styling/SKILL.md`.
...
Optional: `go -C .claude/skills/amaterasu/_jutsu/ui-ux-pro-max/cli run . audit [root]`
