...
- `.claude/skills/tester/SKILL.md` — TDD workflow (Red/Green/Refactor), triangulation matrix, handoff docs `docs/tdd/fase{N}.md` + `docs/tdd/fase{N}Task.md`, `docs/testsReadme.md` registry.
